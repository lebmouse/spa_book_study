...
spa.shell = (function() {
  ...
  // 저장된 앵커 맵의 복사본을 반환한다. 이를 통해 연산 부담을 초소회한다.
  ...
  */
  ...
  // ---------------- DOM methods /toggleChat/ BEGIN ----------------
  // 목적 : 채팅 슬라이더 영역을 열고 닫는다.
  // 인자 :
  //  * do_extend - true is open, false is close
  //  * callback - 애니메이션 종료 시점에 callback 함수를 실행한다.
  // 설정 :
  //    * chat_extend_time, chat_retacte_time
  ...
  // ---------------- DOM methods /toggleChat/ END ----------------
  // END DOM methods

  // --------------- eventHandler BEGIN ---------------------------
  /*
      이벤트 핸드럴 /onHashchange/ 시작
  ...
  */
  ...
  initModule = function($container) {
    ...
    stateMap.is_chat_retracted = true;
    jqueryMap.$chat.attr("title", configMap.chat_retracted_titme).click(onClickChat);
